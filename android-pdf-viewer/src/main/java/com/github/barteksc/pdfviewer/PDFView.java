...
public class PDFView extends RelativeLayout {
    ...
    private float contentOffset = 0f;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float currentXOffset = this.currentXOffset + (swipeVertical ? 0 : contentOffset);
        float currentYOffset = this.currentYOffset + (swipeVertical ? contentOffset : 0);
    ...
    void loadComplete(PdfFile pdfFile) {
        ...
        pdfFile.setDocumentExtraLen(contentOffset);
    ...
    public class Configurator {
        ...
        public Configurator contentOffset(float offset) {
        ...
        public void load() {
            ...
            PDFView.this.contentOffset = this.contentOffset;
